...
$bible_version=
"$option&amp;sm=$sm&amp;c=$c&amp;iday=$iday&amp;imonth=$imonth&amp;iyear=$iyear"; $go_bible_search="index.php?option=$bible_version&amp;view=showsyn&amp;of"; ?>  
<p <?php echo $text_1; ?>>
The Twenty-Fifth Day of the Blessed Month of Bashans
</p>
      <p <?php echo $text_2; ?>>Martyrdom of St.Colluthus of Antinoe
     (Known as Abu Colta)</p>
     <?php  if(file_exists("icons/Bashans25-1.jpg")){ echo "<p $text_3m > <img src=\"./icons/Bashans25-1.jpg\" style=\"float:left;margin:10px; max-width:100px;\" alt=\"icon\" /><br /><br />"; } else {echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";}?>
 On this day, St. Colluthus of Antinoe was martyred.
     ...
     great influence to keep scorpions away until this day.
      ...
      <p <?php echo $text_2; ?>>Departure of the most honored Layman
     Ibrahim El-Gohari</p>
     <?php  if(file_exists("icons/Bashans25-2.jpg")){ echo "<p $text_3m > <img src=\"./icons/Bashans25-2.jpg\" style=\"float:left;margin:10px; max-width:100px;\" alt=\"icon\" /><br /><br />"; } else {echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";}?>
 On this day also of the year 1511
     ...
     of egypt, a position which is equal to prime minister today.</p>
   <?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
 ...
 Ibrahim El-Gohari became
     ...
     also died shortly afterwards and she was a young virgin.</p>
     <?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
 ...
 Ibrahim El-Gohari remained
     ...
     and also in the &quot;Katamares&quot; kept in the same monastery.</p>
    <?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
 ...
 The famous historian El-Gabarty
     ...
     permission from the government, which were rarely granted.</p>
  <?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
 ...
 One of the princesses came
     ...
     a wall around it, and the extension was about 2400 square meter.</p>
<?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
 ...
 In summary, he built and
     ...
     </p><p <?php echo $text_4; ?>>May Their prayers be with us and Glory be to our God forever. Amen.  
         </p>
