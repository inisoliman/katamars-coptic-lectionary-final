...
<p <?php echo $text_2; ?>>Commemoration of the Appearance of the
Bodies of St.John the Baptist and Elisha the Prophet</p>
<?php  if(file_exists("icons/Baunah2-1.jpg")){ echo "<p $text_3m > <img src=\"./icons/Baunah2-1.jpg\" style=\"float:left;margin:10px; max-width:100px;\" alt=\"icon\" /><br /><br />"; } else {echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";}?>
...
not be thrown down&quot; <?php echo "<a $bible_links href=\"$go_bible_search=matthew24:2-2\">"; ?><i> 
(Matthew 24:2)</i></a>. He supplied the Jewish people with
...
he could build a church for them.</p>
<?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
...
manifested through them.<b></b>
 <b>As of the end of Julian the infidel was as follows:</b></p>
<?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
...
</p><p <?php echo $text_4; ?>>May their prayers be with us. Amen.</p> 
 
  <p <?php echo $text_2; ?>> Departure of Pope Yoannis the Eighteenth,
the 107th Pope of Alexandria</p>
<?php  if(file_exists("icons/Baunah2-2.jpg")){ echo "<p $text_3m > <img src=\"./icons/Baunah2-2.jpg\" style=\"float:left;margin:10px; max-width:100px;\" alt=\"icon\" /><br /><br />"; } else {echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";}?>
...
the East, and he gathered its copies and burned them.</p>
<?php echo "<p $text_3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";?>
...
</p><p <?php echo $text_4; ?>>May his prayers be with us and Glory be to God forever. Amen.</p> 
